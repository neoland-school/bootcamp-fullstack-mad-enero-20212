...
import ImageAf from '../../assets/img/af.jpg';
import ImageAg from '../../assets/img/ag.jpg';
...
function CardList() {
    ...
    const getCountry = (c,i) => <Card isDark={i%2===0} name={c.name_en} code={c.code} prefix={c.dial_code} image={ImageAf}></Card>;
    ...
    return (
        <section className='card-list__container'>
            ...
            {
                countries
                    .filter(c => c.name_en.length > 10)
                    .map(getCountry)
            }
            

            {/* <Card name="Algeria" code="AG" prefix="+295" image={ImageAg}></Card>
            <Card isDark={true} name="American Samoa" code="AM" prefix="+222" image={ImageAg}></Card>
            <Card name="Andorra" code="AD" prefix="+376" image={ImageAg}></Card> */}
        </section>
    )
}
