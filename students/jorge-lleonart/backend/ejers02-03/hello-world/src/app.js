...
// 1. Hello world express: Construir una aplicación express en el puerto 6000 que tenga una ruta GET con el path '/' que devuelva un texto con el mensaje 'Hello World Express'. Modificar la aplicación para que opcionalmente se pueda indicar el puerto como primer argumento del programa.
...
app.get('/products/:id', (req, res) => {
    ...
    const filteredProducts = arrProducts.some(c => c.id===req.params.id);
    // console.log(req.params)
    res.send(filteredProducts? 'Okey!':'error 404')
})
...
app.patch('/products/:id', function (req, res) {
    // esto es la opcion corta que ha hecho Jose
    // const id = req.params.id
    // let user=user.find(v=> v.id === parseInt(id))
