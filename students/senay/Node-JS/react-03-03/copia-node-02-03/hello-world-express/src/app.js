...
app.delete('/products/:id', function (req, res) {
    ...
    res.send('Got a DELETE request at /products.json');
});
...
// Hint: para devolver un status customizado en la respuesta debemos utilizar el api de la response status
// (https://expressjs.com/en/4x/api.html#res.status) (editado) 
