...
document.write(`<p>${JSON.stringify(countryListAllIsoData.filter(v=> v.name.startsWith("J")))} </p>`)

document.write(`<p>${JSON.stringify(countryListAllIsoData.find(v => v.code === "MG"))} </p>`)